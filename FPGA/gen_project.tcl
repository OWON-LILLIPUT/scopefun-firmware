...
#
# Generated by Vivado on Sun Jan 13 16:58:47 +0100 2019
...
set_msg_config  -ruleid {1}  -id {USF-XSim-62}  -suppress  -source 16
set_msg_config  -ruleid {2}  -id {Designutils 20-266}  -string {{WARNING: [Designutils 20-266] Invalid Voltage Source VCCINTIO for the family artix7. Ignoring the voltage setting.}}  -suppress  -source 8
...
set_property -name "webtalk.xsim_launch_sim" -value "1884" -objects $obj
...
# remove generic sim_1 (created by default by vivado)
current_fileset -simset [ get_filesets holdoff ]
